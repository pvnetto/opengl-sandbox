...
Camera camera(
	glm::vec3(-3.f, 1.4f, 4.2f),
	glm::vec3(-15.f, -59.f, 0.f),
...
int main() {
	...
	Shader phongShader("C:/Users/USUARIO/Desktop/Projects/Study/opengl-sandbox/src/shaders/09_specular_map.vert",
	              "C:/Users/USUARIO/Desktop/Projects/Study/opengl-sandbox/src/shaders/10_point_light.frag");
	...
	while (!glfwWindowShouldClose(m_window)) {
		...
		glm::vec3 lightSourcePos{0.f, 0.f, glm::cos((float)glfwGetTime()) * -10.f};
